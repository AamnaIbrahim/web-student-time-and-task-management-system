  ...
  return (
    <div className="glass-panel group relative overflow-hidden p-5 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="relative flex items-start justify-between">
        <div
          className="flex h-11 w-11 items-center justify-center rounded-xl text-sm font-semibold text-white shadow-md"
          style={{ backgroundColor: subject.color }}
        >
      ...
      <h3 className="relative mt-3 text-sm font-semibold text-slate-800">
        {subject.name}
      </h3>
